...
CREATE TABLE `customer` (
  ...
  `age` varchar(2) DEFAULT NULL,
  `phonenumber_1` varchar(15) NULL,
  `phonenumber_2` varchar(15) DEFAULT NULL,
  `occupation` varchar(30) DEFAULT NULL,
  `have_more_workers` tinyint(1) NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `job_offer` (
  ...
  `applicants_for_hiring` int NULL,
  `applicant_experience` tinyint(1) NULL,
  `applicant_tattoos_piercings` tinyint(1)  NULL,
  `applicant_disability` tinyint(1) NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `work_reference` (
  ...
  `FK_id_applicant` bigint NULL,
  `reference_name` varchar(60)  NULL,
...
-- Dump completed on 2023-05-19 11:03:25
