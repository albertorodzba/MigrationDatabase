...
public class FilePersonalGeneral
{
    ...
    public void storeOtherColumns(Applicant? applicant, string[,] content, int i)
    {
        ...
        if (content[i, 3].Contains("Cheef"))
        {
            desiredJob.FkIdApplicant = applicant.IdApplicant;
            desiredJob.FkIdJob = 25;
        }
        else if (content[i, 3].Contains("Mesero"))
        {

            desiredJob.FkIdApplicant = applicant.IdApplicant;
            desiredJob.FkIdJob = 26;

        }
        else if (content[i, 3].Contains("Recepcion"))
        {
            desiredJob.FkIdApplicant = applicant.IdApplicant;
            desiredJob.FkIdJob = 27;
        }
        else
        {
            desiredJob.FkIdApplicant = applicant.IdApplicant;
            desiredJob.FkIdJob = 28;
        }
        ...
        //  3 | Vetada        
        //  4 | No disponible
        if (content[i, 13].Contains("Disponib") || content[i, 13].Contains("En Espera"))
        {
            applicant.FkIdJobStatus = 2;
        }
        else if ( content[i, 13].Contains("No Disponible"))
        {
